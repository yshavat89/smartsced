"""
Django settings for smartsced1 project.
...
SECRET_KEY = 'iw3ezniv&h&dead^jf%j129oickaa+=mhpqarxt6@q6tf4(xs^'
...
WSGI_APPLICATION = 'smartsced1.wsgi.application'
